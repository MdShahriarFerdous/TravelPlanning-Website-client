                ...
                <div className="upper-content">
                  <div className="text-content me-4">
                    ...
                    <ul className="styled-list-one">
                      <li>
                        Aliqua quis pariatur irure ea id voluptate et
                        adipisicing magna laboris labore.
                      </li>
                      <li>
                        Aute ullamco commodo incididunt et ea minim occaecat
                        eiusmod commodo ipsum incididunt consectetur.
                      </li>
