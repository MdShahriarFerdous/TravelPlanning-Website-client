		...
		<>
			...
			>
				<div className="container">
					<h3 className="mb-4">{tourDetails?.getTourInfo?.title}</h3>
					{tourDetails && tourDetails?.getTourInfo?.images && (
						<div className="row g-2">
							<div className="col-lg-8">
								{/* Display the first image in col-lg-8 */}
								<img
									src={tourDetails.getTourInfo.images[0]}
									style={{
										width: "100%",
										height: "100%",
										display: "block",
				...
				<div className="row mt-3 g-0">
					<div class="col-lg-8">
						<div className="card  p-4">
							...
							{tourDetails?.getTourInfo?.locations.map((area) => (
								<>
									<ul>
										<li>{area}</li>
									</ul>
							...
							<p>{tourDetails?.getTourInfo?.maxGroupSize}</p>
						</div>
					</div>
