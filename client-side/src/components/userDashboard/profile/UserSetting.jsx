    ...
    return (
        <div className='container card mt-3 p-4'>
           ...
           <form className='mt-3'>
            ...
            <input type="text" className="form-control my-1 py-3 info-input" placeholder='username' />
            <label htmlFor="">New Password</label>
            <input type="password" className="form-control my-1 py-3 info-input" placeholder='**********' />
            <div className='mt-2'>
