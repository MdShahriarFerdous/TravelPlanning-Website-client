        ...
        <div className="col-lg-8">
              ...
              >
                ...
                >
                  <h6 className="text-uppercase">
                    ...
                    {flightData?.destinationLocation?.location_name}
                  </h6>
                  <div
                    id="toggle-0"
                          ...
                          <div className="airplane-info">
                            ...
                            <div className="airplane-info-text">
                              <span className="airplane-name text-uppercase">
                                {" "}
                                {flightData?.airlineInfo?.airline_name}{" "}
                              </span>
                              ...
                              <div className="fare-content-wrapper">
                                <div className="content-item">
                                  ...
                                  <span className="flight-price text-center">
                                    BDT{" "}
                                    {comaFormatNumber(
                                      flightData?.fare ? flightData?.fare : 0,
                                    )}
                                  </span>
                                  <span className="flight-price text-right">
                                    BDT{" "}
                                    {comaFormatNumber(
                                      flightData?.tax ? flightData?.tax : 0,
                                    )}
                                  </span>
                                </div>
                              </div>
                              ...
                              <div className="rule-wrapper">
                                ...
                                <div className="fare-rule-content">
                                  ...
                                  <span className="cancellation-note">
                                    *The airline's fee is indicative and per
                                    person. Convenience fee is non-refundable.
                                  </span>
                                </div>
                              </div>
                            </div>
          ...
          <span>
            <div>
              <div
                className={`card ${
                  collapsedSections.passengerDetails ? "collapsed" : ""
                }`}
              >
                <span>
                  <div
                    className="form-header"
                    onClick={() => toggleCollapse("passengerDetails")}
                  >
                  ...
                  <div
                    className={`collapse ${
                      collapsedSections.passengerDetails ? "" : "show"
                    }`}
                  >
                    <div className="card-body">
                            ...
                            <div>
                              <div role="group" className="input-group">
                                <input
                                  ...
                                  className="form-control"
                                  onChange={(e) =>
                                    handleInputChange("nid", e.target.value)
                                  }
                                  value={formData.nid}
                                />
                              </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <fieldset className="form-group" htmlFor="email-0">
                            <legend
                              tabIndex={-1}
                              className="bv-no-focus-ring col-form-label pt-0"
                            >
