              ...
              <div className="wrapper">
                ...
                <div className="header-summary">
                  <div className="fare-type">
                    <img
                      src="https://www.gozayaan.com/img/flight.27f98987.svg"
                      alt="airplane icon"
                    />
                    <span>Flight</span>
                  </div>
                  ...
                  <div className="fare-item">
                    ...
                    <span className="fare-price">
                      ...
                      <span className="lg-text">
                        {comaFormatNumber(flightData?.fare * traveler)}
                      </span>
                    </span>
                  </div>
                  <div className="fare-item">
                ...
                <div className="fare-info-content">
                  <div className="fare-item">
                    ...
                    <span className="fare-price">
                      ...
                      <span className="lg-text">
                        {comaFormatNumber(
                          flightData?.total_price ? flightData?.total_price : 0,
                        )}
                      </span>
                    </span>
                  </div>
