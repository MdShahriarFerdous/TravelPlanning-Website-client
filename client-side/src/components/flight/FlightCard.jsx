import {getAllLocation} from "../../_api/LocationApi.js";
...
const FlightCard = ({formData}) => {
    ...
    const [timer, setTimer] = useState({ minutes: 1, seconds: 60 });
                                ...
                                <div className="timer-number">
                                    ...
                                    <div>
                                        <div className="timer-value">
                                            ...
                                            <div style={{ width: '30px' /* Adjust this width as needed */ }}>
