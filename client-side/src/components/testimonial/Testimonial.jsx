...
const Testimonial = () => {
  ...
  useEffect(() => {
    axios
      .get("https://travelplanning-website-server.onrender.com/api/v1/testimonial")
      ...
      <div className="auto-container">
        ...
        <div className="carousel-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
          <div className="bg-grad-left">
            <img src="src/assets/images/background/bg-gradient-8.png" alt="" title="" />
          </div>
          <div className="bg-grad-right">
            <img src="src/assets/images/background/bg-gradient-7.png" alt="" title="" />
          </div>
          <div className="d-elem-1">
            <img src="src/assets/images/elements/pink-2.png" alt="" />
          </div>
          <div className="testimonial-carousel">
            <Slider {...settings}>{testimonial ? testimonial.map((item, index) => <TestimonialOne key={index} testimonial={item} />) : "Not loading yet"}</Slider>
          </div>
        </div>
      </div>
    </div>
